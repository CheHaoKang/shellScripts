...
to_addr_success=['Decken_Kang@Compalcomm.com','San_Hsu@compalcomm.com','nash_wang@compalcomm.com','Jacky_Chang@Compalcomm.com','Terri_Chen@Compalcomm.com','Ericyt_Lin@Compalcomm.com','David_Chang@Compalcomm.com','Kuanhung_Chen@Compalcomm.com','Tinna_Lai@Compalcomm.com','Sean_Liong@Compalcomm.com','JuLin_Shih@Compalcomm.com','Johnny_Wu@Compalcomm.com','David_Chih@Compalcomm.com','Cliff_Huang@Compalcomm.com','Miguel_Wang@Compalcomm.com','chichen_lin@Compalcomm.com','Jenny_Kao@Compalcomm.com','Ryan_Huang@Compalcomm.com','Maureen_Chang@Compalcomm.com','Teddy_Chen@Compalcomm.com','Vance_Chen@Compalcomm.com']
to_addr_fail=['Alan_Deng@Compalcomm.com','Gary_Yeh@Compalcomm.com','Bruno_Lin@Compalcomm.com','Decken_Kang@Compalcomm.com','San_Hsu@compalcomm.com','nash_wang@compalcomm.com','Jacky_Chang@Compalcomm.com','Terri_Chen@Compalcomm.com','Ericyt_Lin@Compalcomm.com','Sam_Chen@compalcomm.com','David_Chang@Compalcomm.com','Kuanhung_Chen@Compalcomm.com','Linda_Her@Compalcomm.com','Tinna_Lai@Compalcomm.com','Sean_Liong@Compalcomm.com','JuLin_Shih@Compalcomm.com','Johnny_Wu@Compalcomm.com','David_Chih@Compalcomm.com','Cliff_Huang@Compalcomm.com','Miguel_Wang@Compalcomm.com','chichen_lin@Compalcomm.com','Jenny_Kao@Compalcomm.com','Ryan_Huang@Compalcomm.com','Maureen_Chang@Compalcomm.com','Teddy_Chen@Compalcomm.com','Vance_Chen@Compalcomm.com']
...
subject="CCI Modem " + build_type + " " + build_project + " modem"
if build_type == "Weekly Build":
	subject += "." + build_label
else:
	subject += " " + build_date

if os.getenv("cm_build_modem_ok") == "y":
	subject += " success"
else:
	subject += " failed"
...
<p class=MsoNormal><font size=2 face=Tahoma><span lang=EN-US style='font-size:10.0pt;font-family:Tahoma'>Modem Build SUCCESS</span></font></p>"""
else:
    mail_msg_str += """<p class=MsoNormal><font size=2 face=Tahoma><span lang=EN-US style='font-size:10.0pt;font-family:Tahoma'>Dear All,</span></font></p>
<p class=MsoNormal><font size=2 face=Tahoma><span lang=EN-US style='font-size:10.0pt;font-family:Tahoma'>Modem Build FAIL</span></font></p>"""
